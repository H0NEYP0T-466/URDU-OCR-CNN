...
- GitHub Issues (for general concerns)
...
## Additional Guidelines for URDU-OCR-CNN

### Language and Communication

* Be patient with contributors who may not be native English speakers
* Respect cultural differences and diverse perspectives
* Focus on technical merit rather than personal characteristics
* Keep discussions constructive and on-topic

### Technical Collaboration

* Provide constructive code reviews with specific suggestions
* Welcome questions from newcomers and help them learn
...
* Support a learning environment where mistakes are opportunities for growth
...
1. Opening a confidential issue
...
We are committed to:
- Responding to all reports within 48 hours
- Investigating all complaints fairly and thoroughly
...
Thank you for helping make URDU-OCR-CNN a welcoming, inclusive community for everyone! 🙏
